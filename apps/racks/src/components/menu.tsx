import { Button, buttonVariants } from '@racks/ui/core/components/button';
import {
  Menubar,
  MenubarCheckboxItem,
  MenubarContent,
  ...
  MenubarSubTrigger,
  MenubarTrigger,
} from '@racks/ui/core/components/menubar';
...
export function Menu() {
  ...
  return (
    <Menubar className="rounded-none border-none px-2 lg:px-4 z-50">
      <MenubarMenu>
